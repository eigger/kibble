...
| P1-28 | **i18n ko + en 양쪽 사전** | **완료** — UI 컴포넌트 `t()` 전수, LanguageToggle i18n. PWA manifest·Next metadata는 정적 영문 |
...
| P1-33 | `.env.example` + `docs/deploy.md` | **완료** — Compose·GHCR·Proxmox·환경 변수·트러블슈팅 |
