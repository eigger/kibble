...
-- CreateEnum
CREATE TYPE "ScaleType" AS ENUM ('FECAL_7', 'APPETITE_3', 'ENERGY_3', 'URINE_AMOUNT_3');
...
-- CreateIndex
CREATE UNIQUE INDEX "Event_householdId_dedupeKey_key" ON "Event"("householdId", "dedupeKey");
...
-- AddForeignKey
ALTER TABLE "Reminder" ADD CONSTRAINT "Reminder_lastEventId_fkey" FOREIGN KEY ("lastEventId") REFERENCES "Event"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ApiToken" ADD CONSTRAINT "ApiToken_petId_fkey" FOREIGN KEY ("petId") REFERENCES "Pet"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ApiToken" ADD CONSTRAINT "ApiToken_eventTypeId_fkey" FOREIGN KEY ("eventTypeId") REFERENCES "EventType"("id") ON DELETE SET NULL ON UPDATE CASCADE;


-- Prisma schema로 표현되지 않는 부분 인덱스
