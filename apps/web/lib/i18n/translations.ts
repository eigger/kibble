...
const dict = {
  ...
  todayTitle: { ko: "오늘", en: "Today" },
  todayTimelineLabel: { ko: "오늘의 기록", en: "Today's logs" },
  todayEmpty: {
    ko: "오늘 기록이 없습니다. 가운데 기록 버튼으로 추가하세요.",
    en: "No logs today yet. Tap Record in the center to add one.",
  },
  todayRecordLink: { ko: "빠른 기록으로 추가 →", en: "Add via quick log →" },
  todayLoadError: { ko: "오늘 기록을 불러오지 못했습니다.", en: "Could not load today's logs." },
  ...
  "eventType.supplement": { ko: "영양제", en: "Supplement" },
  "eventType.energy": { ko: "활력", en: "Vitality" },
