...
const dict = {
  ...
  // routines (§7.24) — 미리 정한 값으로 1탭 저장
  quickModeLabel: { ko: "입력 방식", en: "Input mode" },
  quickModeChips: { ko: "기록 칩", en: "Chips" },
  quickModeRoutines: { ko: "루틴", en: "Routines" },
  routinesManageLink: { ko: "관리", en: "Manage" },
  routineSavedToast: {
    ko: "{label} — {count}건 저장했습니다.",
    en: "{label} — {count} saved.",
  },
  routinesTitle: { ko: "루틴", en: "Routines" },
  routinesIntro: {
    ko: "자주 똑같이 기록하는 것을 미리 정해 두면 기록 화면에서 한 번에 저장됩니다. 사료 10g, 영양제 3종처럼요.",
    en: "Predefine what you log the same way every time, then save it with one tap on the log screen — 10g of food, three supplements, and so on.",
  },
  routinesHint: {
    ko: "기록 화면 아래 입력 바에 루틴 탭이 생깁니다. 기록 탭을 다시 누르거나 옆으로 밀어 바꿉니다.",
    en: "A Routines tab appears in the log screen's input bar. Tap the Log tab again or swipe to switch.",
  },
  routinesEmpty: { ko: "아직 루틴이 없습니다.", en: "No routines yet." },
  routinesNew: { ko: "새 루틴", en: "New routine" },
  routineNewTitle: { ko: "새 루틴", en: "New routine" },
  routineEditTitle: { ko: "루틴 수정", en: "Edit routine" },
  routineLabelField: { ko: "이름", en: "Name" },
  ...
  routineItemUnit: { ko: "단위", en: "Unit" },
  routineDeleteConfirmTitle: { ko: "이 루틴을 삭제할까요?", en: "Delete this routine?" },
  routinesSavedToast: { ko: "루틴을 저장했습니다.", en: "Routine saved." },
  routinesDeletedToast: { ko: "루틴을 삭제했습니다.", en: "Routine deleted." },
  routinesLoadError: { ko: "루틴을 불러오지 못했습니다.", en: "Could not load routines." },
  ...
  eventDetailTemperature: { ko: "체온", en: "Temperature" },
  ...
  eventDetailTemperatureMethod: { ko: "측정 방법", en: "Method" },
  ...
  careIngredients: { ko: "성분 (선택)", en: "Ingredients (optional)" },
  careIngredientsPlaceholder: {
    ko: "예: 프레드니솔론 5mg, 우르소데옥시콜산 100mg",
    en: "e.g. prednisolone 5mg, ursodiol 100mg",
  },
  carePastSection: { ko: "지난 처방", en: "Past courses" },
  carePastToggle: { ko: "지난 처방 {count}", en: "Past courses {count}" },
  carePastLoadError: { ko: "지난 처방을 불러오지 못했습니다", en: "Could not load past courses" },
  carePastOngoing: { ko: "진행 중", en: "Ongoing" },
  carePastIngredientsChanged: { ko: "성분 변경", en: "Changed" },
  carePastNoIngredients: { ko: "성분 미입력", en: "No ingredients" },
  carePastDoses: { ko: "{given}회", en: "{given} doses" },
  carePastDosesOfTotal: { ko: "{given}/{total}회", en: "{given}/{total} doses" },
  carePastOpen: { ko: "{name} 처방 열기", en: "Open {name} course" },
  careContinueCourse: { ko: "새 처방으로 이어가기", en: "Continue as new course" },
  careContinueHint: {
    ko: "이 처방의 값을 그대로 가져왔습니다. 저장하면 이전 처방은 종료됩니다.",
    en: "Prefilled from this course. Saving ends the previous course.",
  },
  careContinueHintPast: {
    ko: "이 처방의 값을 그대로 가져왔습니다.",
    en: "Prefilled from this course.",
  },
  careContinued: { ko: "새 처방으로 이어갔습니다", en: "Continued as a new course" },
  careViewDoses: { ko: "이 처방의 복약 기록", en: "Doses for this course" },
  historyCourseFilter: { ko: "처방: {name}", en: "Course: {name}" },
  historyCourseFilterClear: { ko: "처방 필터 해제", en: "Clear course filter" },
  ...
  homeTodayLast: { ko: "마지막 {when}", en: "Last {when}" },
  homeTodayCount: { ko: "{count}회", en: "{count}\u00d7" },
  ...
  analyticsLatestTemperature: { ko: "최근 체온", en: "Latest temp" },
  ...
  analyticsTemperatureChartTitle: { ko: "체온 추이", en: "Temperature trend" },
  ...
  "eventTag.observation.smell": { ko: "냄새", en: "Odor" },
  ...
  "eventTag.temperature.rectal": { ko: "직장(항문)", en: "Rectal" },
  "eventTag.temperature.ear": { ko: "귀", en: "Ear" },
  "eventTag.temperature.axillary": { ko: "겨드랑이", en: "Axillary" },
  "eventTag.temperature.infrared": { ko: "비접촉", en: "Non-contact" },
  ...
  "eventTag.care.nail": { ko: "발톱", en: "Nails" },
  ...
  productFlavorLabel: { ko: "맛", en: "Flavor" },
  productFlavorPlaceholder: { ko: "예: 참치, 치킨", en: "e.g. tuna, chicken" },
  productSectionLabelInfo: { ko: "표기사항", en: "Label info" },
  productRegistrationNoLabel: { ko: "성분등록번호", en: "Registration no." },
  productRegisteredIngredientsLabel: { ko: "등록성분", en: "Guaranteed analysis" },
  productRegisteredIngredientsPlaceholder: {
    ko: "예: 조단백질 30% 이상, 조지방 12% 이상",
    en: "e.g. crude protein 30% min",
  },
  productImporterLabel: { ko: "수입판매원", en: "Importer" },
  productManufacturedAtLabel: { ko: "제조일자", en: "Manufactured" },
  ...
  productFormDry: { ko: "건식", en: "Dry" },
  productFormWet: { ko: "습식", en: "Wet" },
  productFormSemiMoist: { ko: "반습식", en: "Semi-moist" },
  productFormGel: { ko: "겔형 (젤리·양갱)", en: "Gel (jelly)" },
  productFormLickable: { ko: "츄르형", en: "Lickable puree" },
  productFormChewy: { ko: "츄잉형", en: "Chew" },
  productFormPowder: { ko: "파우더", en: "Powder" },
  productFormCapsule: { ko: "캡슐", en: "Capsule" },
  productFormTablet: { ko: "정제", en: "Tablet" },
  productFormLiquid: { ko: "액상", en: "Liquid" },
  productKibbleSizeLabel: { ko: "알갱이 크기", en: "Kibble size" },
  productKibbleSizeSmall: { ko: "소립", en: "Small" },
  productKibbleSizeMedium: { ko: "중립", en: "Medium" },
  productKibbleSizeLarge: { ko: "대립", en: "Large" },
  productWeightLabel: { ko: "구매 중량", en: "Weight" },
  productWeightUnitKg: { ko: "kg", en: "kg" },
  productWeightUnitG: { ko: "g", en: "g" },
  ...
  productSelectRegisteredMulti: { ko: "등록된 제품에서 선택 (여러 개 가능)", en: "Select registered products (multiple allowed)" },
  eventDetailExtraItemsHint: { ko: "함께 준 제품 — 각각 따로 기록됩니다", en: "Given together — each is saved as its own record" },
  eventDetailExtraItemRemove: { ko: "{name} 빼기", en: "Remove {name}" },
  eventDetailCreatedMany: { ko: "기록 {count}건을 저장했습니다.", en: "{count} events saved." },
