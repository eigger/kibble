...
| **P2-13** | **제품(사료·영양제·용품) 관리 및 기록 연동** | **완료 (PR #66)** — `Product` 모델(사료/영양제/간식/위생/기기/기타), CRUD 및 사진 업로드(WebP 1600px), `createEvent()`/`PATCH` 연동(K-4), 퀵 칩 자동 입력, KST 기반 D-Day 계산, 타임라인 페이로드 경량화 |
